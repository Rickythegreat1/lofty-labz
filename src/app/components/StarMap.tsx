    ...
    >
      ...
      {!logoAnimating && (
        ...
        >
          ...
          <Link
            to="/"
            className="flex items-center gap-3 cursor-pointer min-w-[44px] min-h-[44px]"
      ...
      {!logoAnimating && (
        ...
        >
          <Link to="/hailing-frequency">
            <motion.button
              className="px-6 py-3 min-h-[44px] bg-[var(--purple-500)] text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-all cursor-pointer"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              Book a call →
