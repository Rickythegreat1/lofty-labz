...
export const transmissions: Transmission[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Third: we hold a standing reserve, sized as a fixed share of monthly revenue, so that any refund comes from that reserve and not from operating capital. We don\'t publish the dollar figure — we publish the policy.',
